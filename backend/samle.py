...
def sample_process(filename: str, sheet_name: str, start: int, green_const: int, yellow_const: int, bank_name: str, date_start: str, date_end: str, boss_name: str):
    ...
    filtered = df.filter(~pl.col('index').is_in(yellow_df['index'])).drop('index').with_row_index()
